...
public class SpringAiToolTest {
    ...
    public static McpSyncClient sseMcpClient() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://appbuilder.baidu.com")
                .sseEndpoint("/v2/ai_search/mcp/sse?api_key=" + System.getenv("BAIDU_API_KEY"))
                .build();
    ...
    public void test_url() throws MalformedURLException {
        String fullUrl = "http://appbuilder.baidu.com/v2/ai_search/mcp/sse?api_key=" + System.getenv("BAIDU_API_KEY");

        fullUrl = "http://127.0.0.1:9999/sse?apiKey=" + System.getenv("BAIDU_API_KEY");
